    ...
    public static class MinimapManager
    {
        ...
        public static void OnEnabledChanged()
        {
            try
            {
                ...
                isEnabled = enabled;
                isToggled = enabled;
                customCanvasObj?.SetActive(isEnabled && LevelManager.Instance != null);
            }
            catch (Exception e)
            {
        ...
        {
            return isEnabled && IsInitialized && minimapObject != null && (customCanvasObj?.activeInHierarchy ?? false);
        }
        ...
        private static void OnTogglePerformed(InputAction.CallbackContext context)
        {
            if (isEnabled && minimapObject != null)
            {
                ...
                customCanvasObj?.SetActive(isToggled); // 显示/隐藏 Canvas
            }
        }
